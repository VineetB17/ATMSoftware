#designed and developed by group 2-Arnold, Dikxon & Femil
#ATM software
   ...
   # Creating accounts
    ...
    while True:
       ...
       while True:
           ...
           if selection == 1:
               # Printing balance
               print(accountObj.getBalance() ,' Rs')
 
           # Withdraw
           elif selection == 2:
               # Reading amount
               amt = float(input("\nEnter amount to withdraw: "))
               ver_withdraw = input("Is this the correct amount, Yes or No? " + str(amt) + " Rs:")
               ...
               if amt < accountObj.getBalance():
                  ...
                  print("\nUpdated Balance: " + str(accountObj.getBalance()) + " Rs")
               else:
                   winsound.PlaySound("Systemexclamation", winsound.SND_ALIAS) 
                   print("\nYou're balance is less than withdrawl amount: " + str(accountObj.getBalance()) + " Rs")
           ...
           # Deposit
               ...
               ver_deposit = input("Is this the correct amount ,Yes or No?" + str(amt) + " Rs :")
